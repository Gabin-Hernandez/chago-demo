          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Análisis por Categorías</h3>
                  <p className="text-sm text-gray-600">Generales, conceptos y subconceptos</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">Análisis por Divisiones</h3>
                  <p className="text-sm text-gray-600">General, 2nda y 3ra división profesional</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <ul className="list-disc pl-5 space-y-1">
                    ...
                    <li>&quot;Me puedes dar los generales del mes&quot;</li>
                    <li>&quot;Me puedes dar los conceptos del mes&quot;</li>
                    <li>&quot;¿Cuánto gasté en J2 este mes?&quot;</li>
                    <li>&quot;¿Cuáles son los subconceptos del mes?&quot;</li>
                    <li>&quot;¿Cómo se distribuyen los gastos por división?&quot;</li>
